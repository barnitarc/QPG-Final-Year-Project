...
<section class="u-align-center u-clearfix u-gradient u-section-1" src="" id="sec-41e4">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <form action="useradd.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-26 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 32px;" redirect="true">
            ...
            <div class="u-form-group u-form-name u-label-top">
              ...
              <input type="text" placeholder="Enter your Name" id="name-e7b6" name="question" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-18 u-white" required="">
            </div>
            ...
            <div style="align-items: center; display: flex;justify-content: center;">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="userquestions.html" data-page-id="66040615" style="border-radius:15px;background-color:rgb(77, 141, 214); border-color:rgb(77, 141, 214) ;width: 100px; height: 42px;" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-2">back</a>
            </div>
            </div>
      </form>
    </div>
